// src/data/turkeyData.js
// Türkiye'nin 81 ili ve tüm ilçeleri - Tek merkezi veri dosyası
...
export const COUNTRIES = [
  "Türkiye", "Almanya", "Amerika Birleşik Devletleri", "Arjantin", "Arnavutluk", "Avustralya", "Avusturya", "Azerbaycan", 
  "Belçika", "Birleşik Krallık", "Bosna-Hersek", "Brezilya", "Bulgaristan", "Çekya", "Çin", "Danimarka", "Endonezya", 
  "Estonya", "Fas", "Finlandiya", "Fransa", "Güney Afrika", "Güney Kore", "Gürcistan", "Hindistan", "Hırvatistan", 
  "Hollanda", "Irak", "İran", "İrlanda", "İspanya", "İsrail", "İsveç", "İsviçre", "İtalya", "İzlanda", "Japonya", 
  "Kanada", "Karadağ", "Katar", "Kazakistan", "Kıbrıs", "Kırgızistan", "Kolombiya", "Kosova", "Kuveyt", "Kuzey Makedonya", 
  "Küba", "Letonya", "Litvanya", "Lübnan", "Lüksemburg", "Macaristan", "Malezya", "Meksika", "Mısır", "Moğolistan", 
  "Moldova", "Norveç", "Özbekistan", "Pakistan", "Polonya", "Portekiz", "Romanya", "Rusya", "Sırbistan", "Singapur", 
  "Slovakya", "Slovenya", "Suudi Arabistan", "Şili", "Tayland", "Tunus", "Türkmenistan", "Ukrayna", "Ürdün", "Vietnam", 
