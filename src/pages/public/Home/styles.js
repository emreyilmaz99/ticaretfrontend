...
export const getStyles = (isMobile) => ({
  ...
  hero: {
    ...
    margin: isMobile ? '16px 12px' : '40px 60px',
    position: 'relative',
    zIndex: 1,
  ...
  heroContent: {
    ...
    height: '100%',
    margin: '0 auto',
    padding: isMobile ? '30px 16px' : '0 40px',
    display: 'flex',
  ...
  filterBar: {
    ...
    margin: isMobile ? '0 0 20px 0' : '0 auto 40px auto',
  },
  filterGroup: {
    display: 'flex',
    alignItems: 'center',
  ...
  statsSection: {
    ...
    maxWidth: '1000px',
    margin: isMobile ? '0 auto 30px' : '0 auto 80px',
    padding: isMobile ? '0 12px' : '0 20px',
    position: 'relative',
    zIndex: 1,
  },
  ...
  dealSection: {
    ...
    color: 'white',
    padding: isMobile ? '30px 16px' : '80px',
    borderRadius: isMobile ? '16px' : '40px',
    margin: isMobile ? '0 12px 30px' : '0 auto 100px',
    maxWidth: '1200px',
    display: 'flex',
    flexDirection: isMobile ? 'column' : 'row',
    alignItems: 'center',
