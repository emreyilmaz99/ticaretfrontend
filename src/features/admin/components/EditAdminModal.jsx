...
const EditAdminModal = ({ isOpen, onClose, admin }) => {
  ...
  const updateMutation = useMutation({
    ...
    onSuccess: () => {
      toast.success('Başarılı', 'Yönetici başarıyla güncellendi.');
      queryClient.invalidateQueries(['admins']);
      onClose();
    },
    onError: (error) => {
      const errorMsg = error.response?.data?.message || 'Yönetici güncellenemedi.';
  ...
  const validateForm = () => {
    ...
    // Şifre opsiyonel, ama girildiyse kontrol et
  ...
  const handleSubmit = (e) => {
    ...
    // Şifre girilmemişse, şifre alanlarını gönderme
    ...
    updateMutation.mutate({ id: admin.id, data: dataToSend });
  };
      ...
      >
        ...
        <div style={{
          ...
          <p style={{
            ...
            {admin.name} yöneticisinin bilgilerini güncelleyin
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{
            ...
            <div style={{
              ...
              <input
                ...
                style={{
                  ...
                  minHeight: isMobile ? '44px' : styles.input.height,
          ...
          <div style={{
            ...styles.footer,
            flexDirection: isMobile ? 'column-reverse' : styles.footer.flexDirection,
            ...
            <button
              ...
              style={{
                ...styles.cancelButton,
                width: isMobile ? '100%' : styles.cancelButton.width,
                minHeight: isMobile ? '44px' : styles.cancelButton.height,
            ...
            <button
              ...
              style={{
                ...styles.submitButton,
                width: isMobile ? '100%' : styles.submitButton.width,
                minHeight: isMobile ? '44px' : styles.submitButton.height,
